...
describe('EmployeeListComponent', () => {
  ...
  {"id":100004,"firstName":"Sravan","lastName":"Jilla","salary":900000.0,"email":"sravanjilla@gmail.com","job":"HR","password":"$2a$10$BW9L/gFvBBMVd3BNQTDznOUz59c9hgCkn4UZ8CxxgVk59vKkUJBNK","role":"EMPLOYEE","active":false,"loginAttempts":0}];
  let currentEmployee2:Employee = {"id":100003,"firstName":"asdf","lastName":"Jilla","salary":900000.0,"email":"srujanjilla@gmail.com","job":"HR","password":"$2a$10$BW9L/gFvBBMVd3BNQTDznOUz59c9hgCkn4UZ8CxxgVk59vKkUJBNK","role":"EMPLOYEE","active":false,"loginAttempts":0};
  ...
  it('should change Ui when cliekc cancel while add employee', fakeAsync(() => {
    component.currentEmployee = currentEmployee;
    expect(currentEmployee.role).toBe("ADMIN");
    fixture.debugElement.nativeElement.querySelector('#addEmployee').click();
    fixture.detectChanges();
