...
describe('LoginComponent', () => {
  ...
  it('should navigate to login component', fakeAsync(() => {
    ...
    // employeeService.changeActiveByMail.and.returnValue(of(true));
    flush();
    expect(component).toBeTruthy();
  }));

  it(' email doesnot existt', fakeAsync(() => {
  ...
  it('should navigate milli seconds login component', fakeAsync(() => {
    employeeService.emailExists.and.returnValue(of(true));
    employeeService.getFailedLoginAttempt.and.returnValue(of(23));
    component.test2 = true;
    fixture.debugElement.nativeElement.querySelector('button').click();
    fixture.detectChanges();
    // employeeService.changeActiveByMail.and.returnValue(of(true));
    flush();
