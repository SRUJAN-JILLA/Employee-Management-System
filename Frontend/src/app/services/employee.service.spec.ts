...
describe('EmployeeService', () => {
  ...
  it('should retrive all employees', () => {
    ...
    req.flush([{"id":100003,"firstName":"Srujan","lastName":"Jilla","salary":900000.0,"email":"srujanjilla@gmail.com","job":"HR","password":"$2a$10$BW9L/gFvBBMVd3BNQTDznOUz59c9hgCkn4UZ8CxxgVk59vKkUJBNK","role":"ADMIN","active":false,"loginAttempts":0,"lockTime":"2022-12-16T11:26:49.392+00:00"}]);
  });
...
it('should add new employee', () => {
    let employee:Employee = {"id":100003,"firstName":"Srujan","lastName":"Jilla","salary":900000.0,"email":"srujanjilla@gmail.com","job":"HR","password":"$2a$10$BW9L/gFvBBMVd3BNQTDznOUz59c9hgCkn4UZ8CxxgVk59vKkUJBNK","role":"ADMIN","active":false,"loginAttempts":0}
    employeeService.addEmployee(employee).subscribe(data =>{
        
        expect(data).toBeTruthy('Nothing Returned.');
        expect(data).toEqual("Added");
    })
    const req = httpTestingController.expectOne('http://localhost:8080/employees/add');
...
it('should update employee', () => {
    let employee:Employee = {"id":100003,"firstName":"Srujan","lastName":"Jilla","salary":900000.0,"email":"srujanjilla@gmail.com","job":"HR","password":"$2a$10$BW9L/gFvBBMVd3BNQTDznOUz59c9hgCkn4UZ8CxxgVk59vKkUJBNK","role":"ADMIN","active":false,"loginAttempts":0}
    employeeService.updateEmployee(100003,employee).subscribe(data =>{
        
        expect(data).toBeTruthy('Nothing Returned.');
        expect(data).toEqual("Updated");
    })
    const req = httpTestingController.expectOne('http://localhost:8080/employees/update/100003')
...
// it('should download', () => {
//     employeeService.download("excel").subscribe(xls =>{
//         expect(xls).toBeTruthy('Nothing Returned.');
//       });
//     const req = httpTestingController.expectOne('http://localhost:8080/employees/download/excel')
//     expect(req.request.method).toEqual("GET");  
